 ...
 * 
 * Topics Subscribed:
 * - cam0HP/yolo/bounding_boxes (Detection2DArray)
 * - cam1HP/yolo/bounding_boxes (Detection2DArray)
 */
...
// ============================================================================
// UTILITY STRUCTURES (Will be moved to shared_types.hpp later)
// ============================================================================
...
private:
    ...
    // ========================================================================
    // CALLBACKS (STUB - Will be filled from robot_logic_node.cpp)
    // ========================================================================
    void camera1Callback(const Detection2DArray::SharedPtr msg) {
        // TODO: Move full logic from robot_logic_node.cpp
        // For now, just log receipt
        RCLCPP_DEBUG(get_logger(), "[VISION] Cam0 received %zu detections", msg->detections.size());
        
        // Placeholder: publish -1 (no selection)
    ...
    void camera2Callback(const Detection2DArray::SharedPtr msg) {
        // TODO: Move full logic from robot_logic_node.cpp
        RCLCPP_DEBUG(get_logger(), "[VISION] Cam1 received %zu detections", msg->detections.size());
