...
public slots:
    ...
    Q_INVOKABLE void triggerState2();      // Pub done_tray_input → STATE 2
    Q_INVOKABLE void triggerState4();      // Pub done_tray_output → STATE 4
    Q_INVOKABLE void s7Acknowledge();      // Operator xác nhận đã cấp khay
...
signals:
    ...
    void s7WarningRequested();   // emitted when S7 timeout (2 min) warning received
